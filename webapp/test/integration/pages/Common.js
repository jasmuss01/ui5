sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("namespace/placeholder/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ProjekteVerwaltung-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ProjekteVerwaltung-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("namespace.placeholder.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["namespace/placeholder/localService/mockserver"], function (mockserver) {
