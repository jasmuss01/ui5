sap.ui.define([
	...
	return BaseController.extend("namespace.placeholder.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ProjektSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("ProjektSet", oData);
