sap.ui.define([
	...
	return BaseObject.extend("namespace.placeholder.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias namespace.placeholder.model.ListSelector
		 */
		 ...
		 * @return {namespace.placeholder.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
